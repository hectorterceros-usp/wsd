...
from similarity import ext_lesk, lesk
from centrality import score_vertices, degree, pagerank
from algorithm import *
from nltk.corpus import wordnet_ic, senseval
...
def teste_tspaco():
    ...
    target_word = instance.word[:-2]  # ainda preciso corrigir isso com o dict
    true_sense = SV_SENSE_MAP[instance.senses[0]]
    instance_score = check_prediction(result, target_word, true_sense)
    return None
